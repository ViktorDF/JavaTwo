...
//Добавить отключение неавторизованных
// пользователей по таймауту
// (120 сек. ждём после подключения клиента,
// и если он не авторизовался за это время,
// закрываем соединение).
    public void run() {
                chat.broadcastMessage("Новый клиент в чате");
            }
    }
